...
public class TestRBT 
{
	...
	private RBT<String, String> arbol;

	@Before
	public void setUp1()
	{
		arbol = new RBT<String, String>();
	}
	...
	public void getHeight( ) 
	{
		...
		setUp4();
		assertEquals(0, arbol.getHeight("X"));
		assertEquals(0, arbol.getHeight("A"));
		assertEquals(1, arbol.getHeight("W"));
		assertEquals(2, arbol.getHeight("Q"));
		assertEquals(3, arbol.getHeight("U"));
		assertEquals(4, arbol.getHeight("I"));
		assertEquals(5, arbol.getHeight("M"));
	}
	...
	{ 
		arbol.put("258", "A258");
		assertTrue(arbol.contains("258"));
		arbol.put("8", "A8");
		assertTrue(arbol.contains("8"));
		arbol.put("58", "A58");
		assertTrue(arbol.contains("58"));
		arbol.put("300", "A300");
		assertTrue(arbol.contains("300"));
		arbol.put("270", "A270");
		assertTrue(arbol.contains("270"));
	}
	...
	public void valuesInRange( ) 
	{
		...
		System.out.println(arbol.valuesInRange("X", "ZZ").getElement(1));
		System.out.println(arbol.valuesInRange("X", "ZZ").size());
